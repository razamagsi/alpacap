                            ...
                            <div class="col-12">
                                ...
                                <table class="table table-image width:100">
                                    ...
                                    ?>
                                         ...
                                         <tr>
                                         <th scope="col" id="status <?=$id?>">Status</th>
                                         <td scope="row"><?php echo "$bustatus"; ?></td>
                                         </tr>
                                ...
                                <?php
                                    ...
                                    if($bustatus == 'Active'){
                                    ?>
                                     <button onclick="status_change(<?=$bid?>)" class='btn btn-outline-primary px-4 ms-3'>Active</button>
                                     <?php 
                                    }
                                   else{
                                       ?>
                                       <button onclick="status_change(<?=$bid?>)" class='btn btn-outline-primary px-4 ms-3'>Blocked</button> 
                                    <?php
                                    }
